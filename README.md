...
3) My third issue was that I had an unexpected bug come up. The button tone would keep playing if the button was accidentally dragged. It didn’t stop unless I refreshed the page or clicked the button once more.
...
4. If you had a few more hours to work on this project, what would you spend them doing (for example: refactoring certain functions, adding additional features, etc). Be specific. (recommended 100 - 300 words) 
	...
	~ Next I would tackle the slight problem of the pattern speeding up, despite the user having made a wrong guess and it is merely repeating. I would need to create some if-statements somewhere to solve this, probably the Guess function.
